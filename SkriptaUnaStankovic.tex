...
Kako bismo kreirali promenljivu u programu, navodimo ključnu reč $var$ (Postoje jos neke ključne reči za kreiranje promenljivih, ali će o njima biti reči kasnije).
\begin{verbatim}
var a;
\end{verbatim}
...
\inputminted{javascript}{examples/JS_uvod_1.html}
