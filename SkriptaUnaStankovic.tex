...
Osim navedenog načina moguće je funkciju dodeliti promenljivoj. Obratiti pažnju da nakon poslednje vitičaste zagrade mora stajati zarez. 
\begin{lstlisting}[backgroundcolor = \color{lightgray}]
...
Anonimne funkcije su funkcije koje nemaju naziv.
...
Funkcija $setTimeout()$ izvršava naredbe nakn vremenskog intervala zadatog u milisekundama. Prvi argument je funkcija koja se izvršava nakon broja milisekundi navedenih kao drugi argument funkcije.
